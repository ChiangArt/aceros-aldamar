...
import { catalogCategories, catalogProducts, type CatalogCategoryId } from "~/lib/catalog";
...
export function ProductCatalog() {
  ...
  const activeCategory = (searchParams.get("cat") ?? "all") as CatalogCategoryId | "all";
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
        <div className="max-w-xl">
          ...
          <p className="text-neutral-500 text-sm font-light leading-relaxed mt-6">
            Explora nuestra amplia gama de aceros y derivados. Filtra por categoría o busca un producto específico por nombre o norma técnica.
          </p>
        </div>

        <div className="relative w-full md:w-80 group">
          <Icon name="arrow-right" size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-500 group-focus-within:text-primary transition-colors rotate-90" />
          <input
            type="text"
